...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Wizard_Bots" -metadata author="@Wizard_Bots" -metadata:s:s title="Subtitled By :- @Wizard_Bots" -metadata:s:a title="By :- @Wizzard_Bots" -metadata:s:v title="By:- @Wizard_Bots" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
